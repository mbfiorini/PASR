...
using PASR.Sessions;
using PASR.Web.Models.Account;
using PASR.Web.Views.Shared.Components.TenantChange;

namespace PASR.Web.Controllers
{
    //Herda Controller Base para possuir as configurações 
    public class AccountController : PASRControllerBase
    {
        ...
        {
            _userManager = userManager; //Repositório de Usuário, busca e grava informações do usuário
            _multiTenancyConfig = multiTenancyConfig;
            _tenantManager = tenantManager;
            _unitOfWorkManager = unitOfWorkManager;
            _abpLoginResultTypeHelper = abpLoginResultTypeHelper; //Contém métodos para formatar as mensagens de retorno, dependendo do resultado da tentativa de Login
            _logInManager = logInManager; //Repositório de Login, busca e grava as informações sobre as tentativas de login realizadas
        ...
        public virtual async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
            ...
            //Preenche o HttpContext.User com a Claims
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    //ExternalLoginInfo guarda as informações do LoginExterno, e aqui comparar se o E-mail 
        ...
        private string NormalizeReturnUrl(string returnUrl, Func<string> defaultValueBuilder = null)
        {
            ...
            {
                defaultValueBuilder = GetAppHomeUrl; //Redirecionar para Home, Sempre que o delegate não vier preechido
            }
