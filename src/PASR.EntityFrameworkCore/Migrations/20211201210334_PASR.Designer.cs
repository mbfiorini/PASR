...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PASR.Calls.Call", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PASR.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PASR.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PASR.Authorization.Users.User", b =>
                {
                    ...
                    b.OwnsOne("PASR.Localization.Address", "Address", b1 =>
                        {
                            ...
                            b1.Property<string>("FederalUnity")
                                .IsRequired()
                                .HasMaxLength(4)
            ...
            modelBuilder.Entity("PASR.Calls.Call", b =>
                {
                    b.HasOne("PASR.Leads.Lead", "Lead")
                        .WithMany("Calls")
                        .HasForeignKey("LeadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PASR.Authorization.Users.User", "User")
                        .WithMany("Calls")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PASR.Teams.Team", b =>
                {
                    b.HasOne("PASR.Authorization.Users.User", "SalesManager")
                        .WithOne()
                        .HasForeignKey("PASR.Teams.Team", "SalesManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
