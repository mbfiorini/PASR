...
{
    public abstract class PASRWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PASRWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PASRWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PASRDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PASRDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PASRDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PASRDbContext, Task<T>> func)
        {
            T result;
